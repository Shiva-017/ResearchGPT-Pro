...
class HybridRAG:
    ...
    def _connect(self):
        ...
        try:
            ...
            logger.info("HybridRAG: Neo4j connected")
    ...
    def enrich(
        ...
        t0 = time.time()
        try:
            ancestors = self.neo4j.get_common_ancestor(paper_ids, limit=3)
        except Exception:
            ancestors = []
        ...
        t0 = time.time()
        try:
            experts = self.neo4j.get_author_expertise(paper_ids, limit=5)
        except Exception:
            experts = []
